...
<div class="fixed bottom-28 right-6 z-50">  <!-- Added fixed positioning and z-50 -->
  <a href="topup.php" class="w-16 h-16 bg-gradient-to-r from-emerald-500 to-teal-500 rounded-full flex items-center justify-center text-white text-2xl shadow-xl pulse-animation hover:scale-110 transition-transform">
    ➕
  </a>
</div>
